...
/**
 * Sun icon component. Used for the theme toggle button.
 */
...
/**
 * Moon icon component. Used for the theme toggle button.
 */
...
/**
 * Code icon component. Used for the 'Code' view tab and the application logo.
 */
export const IconCode: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m16 18 6-6-6-6"/><path d="m8 6-6 6 6 6"/></svg>
);

/**
 * Tree icon component. Used for the 'Tree' view tab.
 */
export const IconTree: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 5v.2A7.2 7.2 0 0 0 5 12.2V17h14v-4.8c0-3.9-3.1-7-7-7Z" /><path d="M10 5a2 2 0 1 1 4 0" /><path d="M6 17v3" /><path d="M18 17v3" /><path d="M12 17v6" /><path d="M12 12v-2" /></svg>
);

/**
 * Table icon component. Used for the 'Table' view tab.
 */
export const IconTable: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 3v18" /><rect width="18" height="18" x="3" y="3" rx="2" /><path d="M3 9h18" /><path d="M3 15h18" /></svg>
);

/**
 * Copy icon component. Used for copy-to-clipboard buttons.
 */
...
/**
 * Checkmark icon component. Used to indicate a successful action, like copying.
 */
...
/**
 * Download icon component. Used for the download button.
 */
...
/**
 * Up arrow icon component. Used to indicate ascending sort order in the table view.
 */
...
/**
 * Down arrow icon component. Used to indicate descending sort order in the table view.
 */
...
/**
 * Right chevron icon component. Used to indicate a collapsed node in the tree view.
 */
...
/**
 * Down chevron icon component. Used to indicate an expanded node in the tree view.
 */
export const IconChevronDown: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m6 9 6 6 6-6"/></svg>
);

/** Bar chart icon — Stats view tab. */
export const IconStats: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"/><rect x="7" y="13" width="3" height="5"/><rect x="12" y="9" width="3" height="9"/><rect x="17" y="5" width="3" height="13"/></svg>
);

/** Search icon — search bar trigger. */
export const IconSearch: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
);

/** X / close icon — close buttons. */
export const IconClose: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
);

/** Sparkles / wand icon — JSON Repair auto-fix. */
export const IconRepair: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 3-1.9 5.8-5.8 1.9 5.8 1.9L12 18.4l1.9-5.8 5.8-1.9-5.8-1.9z"/><path d="M5 21v-4"/><path d="M19 17v4"/></svg>
);

/** Question mark icon — keyboard shortcut help. */
